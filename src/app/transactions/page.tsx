      ...
      <div className={`flex flex-1 flex-col ${inter.className}`}>
        ...
        <main className="p-8">
          <section className="space-y-1">
            <h1 className="text-[30px] font-bold leading-[1.2] tracking-tight text-white">
              Transações
            </h1>
            ...
            <Table>
              <TableHeader className="bg-white/6">
                <TableRow className="border-b border-white/10 hover:bg-transparent">
                  <TableHead className="h-auto px-4 py-4 text-xs font-semibold uppercase tracking-wider text-[#CAD5E2]">
                    Nome
                  </TableHead>
                  <TableHead className="h-auto px-4 py-4 text-xs font-semibold uppercase tracking-wider text-[#94A3B8]">
                    Categoria
                  </TableHead>
                  <TableHead className="h-auto px-4 py-4 text-xs font-semibold uppercase tracking-wider text-[#94A3B8]">
                    Método
                  ...
                  <TableHead className="h-auto px-4 py-4 text-right text-xs font-semibold uppercase tracking-wider text-[#94A3B8]">
                    Valor
                  </TableHead>
                  <TableHead className="h-auto px-4 py-4 text-right text-xs font-semibold uppercase tracking-wider text-[#94A3B8]">
                    Ações
